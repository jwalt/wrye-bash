...
class LaunchButton(_StdImageButton, OkButton):
    """Similar to OkButton, also has a standard image shown on it."""
    _default_label = _(u'Launch')
    _wx_icon = _wx.ART_TICK_MARK
    _dip_size = (32, 32)
