...
class _AliasesPatcherPanel(_PatcherPanel):
    ...
    def _getConfig(self, configs):
        ...
        self._ci_aliases = forward_compat_path_to_fn(
            config.get(u'aliases', {}), value_type=lambda v: FName(str(u'%s' % v))) ##: str needed?
        return config
...
class _ListPatcherPanel(_PatcherPanel):
    ...
    def _getConfig(self, configs):
        """Get config from configs dictionary and/or set to default."""
        config = super(_ListPatcherPanel, self)._getConfig(configs)
...
class _TweakPatcherPanel(_ChoiceMenuMixin, _PatcherPanel):
    ...
    def _getConfig(self, configs):
        """Get config from configs dictionary and/or set to default."""
        config = super(_TweakPatcherPanel, self)._getConfig(configs)
...
class _ListsMergerPanel(_ChoiceMenuMixin, _ListPatcherPanel):
    ...
    def _getConfig(self, configs):
        """Get config from configs dictionary and/or set to default."""
        config = super(_ListsMergerPanel, self)._getConfig(configs)
