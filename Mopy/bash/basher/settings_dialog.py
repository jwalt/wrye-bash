...
class LanguagePage(_AScrollablePage):
    ...
    def __init__(self, parent, page_desc):
        ...
        all_langs = [b for f in bass.dirs[u'l10n'].list() if f.ci_ext == u'.po'
    ...
    def _gather_l10n():
        ...
        return [f for f in bass.dirs[u'l10n'].list() if f.ci_ext == u'.po']
...
class BackupsPage(_AFixedPage):
    ...
    def _populate_backup_list(self):
        ...
        all_backups = [x for x in self._backup_dir.list() if barb.is_backup(x)]
