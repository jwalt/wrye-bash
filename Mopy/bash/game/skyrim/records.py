...
from ...brec import MelRecord, MelObject, MelGroups, MelStruct, FID, \
    ...
    MelOptStruct, MreHeaderBase, MelBase, MelRelations, \
    ...
    def __init__(self):
        MelSequential.__init__(self,
            MelCounter(MelUInt32(b'KSIZ', u'keyword_count'),
                       counts=u'keywords'),
            MelSorted(MelArray(u'keywords', MelFid(b'KWDA'))),
        )
...
class MelVmad(MelBase):
    ...
    class FragmentSCENPhase(_AVmadComponent):
        ...
        _scen_fragment_phase_flags = Flags.from_names(u'on_start',
                                                      u'on_completion')
...
class MreActi(MelRecord):
    ...
    ActivatorFlags = Flags.from_names('noDisplacement', 'ignoredBySandbox')
...
class MreArma(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelFid(b'NAM2', 'skin2'),
        MelFid(b'NAM3', 'skin3'),
        MelSorted(MelGroups(u'additional_races', MelFid(b'MODL'))),
...
class MreArmo(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelKeywords(),
        MelDescription(),
        MelGroups(u'addons', MelFid(b'MODL')),
        MelStruct(b'DATA', [u'i', u'f'],'value','weight'),
...
class MreColl(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelSorted(MelArray(u'collidesWith', MelFid(b'CNAM'))),
    )
    __slots__ = melSet.getSlotsUsed()
...
class MreDlvw(MelRecord):
    ...
    melSet = MelSet(
        MelEdid(),
        MelFid(b'QNAM','quest',),
        MelGroups(u'branches', MelFid(b'BNAM')),
...
class MreEczn(MelRecord):
    ...
    EcznTypeFlags = Flags.from_names('neverResets', 'matchPCBelowMinimumLevel',
...
class MreEfsh(MelRecord):
    ...
    EfshGeneralFlags = Flags.from_names(
        (0, 'noMembraneShader'),
...
class MreEqup(MelRecord):
    ...
    melSet = MelSet(
        MelEdid(),
        MelArray(u'canBeEquipped', MelFid(b'PNAM')),
...
class MreFsts(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelArray(u'footstepSets', MelFid(b'DATA')),
    )
    __slots__ = melSet.getSlotsUsed()
...
class MreHdpt(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelSorted(MelGroups(u'extraParts', MelFid(b'HNAM'))),
        MelGroups('partsData',
...
class MreInfo(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelGroups(u'linkTo', MelFid(b'TCLT')),
...
class MreLctn(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelArray(u'referenceCellPersistentReference', MelFid(b'RCPR')),
        ...
        MelArray(u'referenceCellUnique', MelFid(b'RCUN')),
        ...
        MelArray(u'referenceCellStaticReference', MelFid(b'RCSR')),
        ...
        MelArray(u'actorCellMarkerReference', MelFid(b'ACID')),
        MelArray(u'locationCellMarkerReference', MelFid(b'LCID')),
...
class MreLtex(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelSorted(MelGroups(u'grasses', MelFid(b'GNAM'))),
...
class MreMusc(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelArray(u'musicTracks', MelFid(b'TNAM')),
    )
    __slots__ = melSet.getSlotsUsed()
...
class MreMust(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelConditionCounter(),
        MelConditions(),
        MelArray(u'tracks', MelFid(b'SNAM')),
    )
    __slots__ = melSet.getSlotsUsed()
...
class MreNavi(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelArray(u'navigationMesh', MelFid(b'NVSI')),
    )
    __slots__ = melSet.getSlotsUsed()
...
class MreNpc(MreActorBase):
    ...
    melSet = MelSet(
        ...
        MelSorted(MelGroups(u'head_part_addons', MelFid(b'PNAM'))),
...
class MreOtft(MelRecord):
    ...
    melSet = MelSet(
        MelEdid(),
        MelSorted(MelArray(u'items', MelFid(b'INAM'))),
    )
    __slots__ = melSet.getSlotsUsed()
...
class MrePack(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelStruct(b'PKDT', [u'I', u'3B', u's', u'H', u'2s'], (_GeneralFlags, u'generalFlags'),
                  ...
                  'unknown1_PKDT', (_InterruptFlags, u'interruptFlags'),
                  'unknown2'),
...
class MreQust(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelGroups(u'textDisplayGlobals', MelFid(b'QTGL')),
        ...
        MelGroups('objectives',
            ...
            MelGroups('targets',
                      MelStruct(b'QSTA', [u'i', u'B', u'3s'], ('alias', None),
        ...
        MelGroups(u'qust_aliases',
            ...
            MelGroup('createReferenceToObject',
                ...
                MelStruct(b'ALCA', [u'h', u'H'], ('alias', None), 'create_target'),
            ...
            MelGroups(u'aliasSpells', MelFid(b'ALSP')),
            MelGroups(u'aliasFactions', MelFid(b'ALFC')),
            MelGroups(u'aliasPackageData', MelFid(b'ALPC')),
...
class MreRace(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelSorted(MelArray(u'hairs', MelFid(b'HNAM'))),
        MelSorted(MelArray(u'eyes', MelFid(b'ENAM'))),
...
class MreRefr(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelGroup('bound_data',
            ...
            MelSorted(MelGroups(u'linked_rooms', MelFid(b'XLRM'))),
        ),
        ...
        MelSorted(MelGroups(u'litWaters', MelFid(b'XLTW'))),
        ...
        MelGroups(u'teleportMessageBox', MelFid(b'XTNM')),
        ...
        MelArray(u'locationRefType', MelFid(b'XLRT')),
        MelNull(b'XIS2',),
        MelOwnership(),
...
class MreScen(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelGroups('phases',
            ...
            MelConditions(u'startConditions'),
            MelNull(b'NEXT'),
            MelConditions(u'completionConditions'),
        ...
        MelGroups('actions',
            ...
            MelGroups(u'packages', MelFid(b'PNAM')),
            MelFid(b'DATA','topic'),
...
class MreWthr(MelRecord):
    ...
    melSet = MelSet(
        ...
        MelSorted(MelGroups(u'skyStatics', MelFid(b'TNAM'))),
