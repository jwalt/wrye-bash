...
from ..bolt import structs_cache, struct_calcsize, Rounder, struct_error, \
    PluginStr, ChardetStr
...
class MelGroups(MelGroup):
    ...
    def getDefaulters(self, mel_set_instance, mel_key=u''):
        ...
        def _att(attr):
            return f'{mel_key}.{attr}' if mel_key else attr
